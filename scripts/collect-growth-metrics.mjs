...
const repos = [
  ...
  { name: "fitbit-mcp", vertical: "body", role: "connector", npm: "fitbit-mcp-unofficial" },
  { name: "oura-mcp", vertical: "body", role: "connector", npm: "oura-mcp-unofficial" },
  { name: "withings-mcp", vertical: "body", role: "connector", npm: "withings-mcp-unofficial" },
  ...
  { name: "polar-mcp", vertical: "body", role: "connector", npm: "polar-mcp-unofficial" },
