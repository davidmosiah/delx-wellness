...
| Google Health MCP | [`google-health-mcp-unofficial`](https://www.npmjs.com/package/google-health-mcp-unofficial/v/0.5.1) | `0.5.1` | [`v0.5.1`](https://github.com/davidmosiah/google-health-mcp/releases/tag/v0.5.1) | `npm test`, prod audit, pack dry-run, CodeQL 0 alerts |
