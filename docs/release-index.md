...
|---|---|---:|---|---|
| Delx Living Body | [`delx-living-body`](https://www.npmjs.com/package/delx-living-body/v/0.2.1) | `0.2.1` | [`v0.2.1`](https://github.com/davidmosiah/delx-living-body/releases/tag/v0.2.1) | `npm test`, prod audit, pack dry-run |
| Google Health MCP | [`google-health-mcp-unofficial`](https://www.npmjs.com/package/google-health-mcp-unofficial/v/0.4.8) | `0.4.8` | [`v0.4.8`](https://github.com/davidmosiah/google-health-mcp/releases/tag/v0.4.8) | `npm test`, prod audit, pack dry-run |
| Garmin MCP | [`garmin-mcp-unofficial`](https://www.npmjs.com/package/garmin-mcp-unofficial/v/0.5.2) | `0.5.2` | [`v0.5.2`](https://github.com/davidmosiah/garmin-mcp/releases/tag/v0.5.2) | `npm test`, prod audit, pack dry-run |
| Wellness Nourish | [`wellness-nourish`](https://www.npmjs.com/package/wellness-nourish/v/0.6.7) | `0.6.7` | [`v0.6.7`](https://github.com/davidmosiah/wellness-nourish/releases/tag/v0.6.7) | `npm test`, prod audit, pack dry-run |
