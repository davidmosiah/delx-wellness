...
This page tracks strategic Delx open-source releases verified from npm. Last full reconcile: **2026-08-05** (OSS-100 campaign).

Canonical connector versions: [`registry.json`](../registry.json) via `node scripts/sync-registry.mjs` (single source). Do not hand-edit parallel tables without re-syncing.
...
| Google Health MCP | [`google-health-mcp-unofficial`](https://www.npmjs.com/package/google-health-mcp-unofficial/v/0.7.3) | `0.7.3` | [repo](https://github.com/davidmosiah/google-health-mcp) | `npm view` + registry sync |
| Garmin MCP | [`garmin-mcp-unofficial`](https://www.npmjs.com/package/garmin-mcp-unofficial/v/0.7.1) | `0.7.1` | [repo](https://github.com/davidmosiah/garmin-mcp) | `npm view` + registry sync |
| Strava MCP | [`strava-mcp-unofficial`](https://www.npmjs.com/package/strava-mcp-unofficial/v/0.6.0) | `0.6.0` | [repo](https://github.com/davidmosiah/strava-mcp) | `npm view` + registry sync |
| Fitbit MCP | [`fitbit-mcp-unofficial`](https://www.npmjs.com/package/fitbit-mcp-unofficial/v/0.6.0) | `0.6.0` | [repo](https://github.com/davidmosiah/fitbitmcp) | `npm view` + registry sync |
| Polar MCP | [`polar-mcp-unofficial`](https://www.npmjs.com/package/polar-mcp-unofficial/v/0.5.0) | `0.5.0` | [repo](https://github.com/davidmosiah/polarmcp) | `npm view` + registry sync |
...
| WHOOP MCP | [`whoop-mcp-unofficial`](https://www.npmjs.com/package/whoop-mcp-unofficial/v/0.6.0) | `0.6.0` | [repo](https://github.com/davidmosiah/whoop-mcp) | `npm view` + registry sync |
| Withings MCP | [`withings-mcp-unofficial`](https://www.npmjs.com/package/withings-mcp-unofficial/v/0.5.0) | `0.5.0` | [repo](https://github.com/davidmosiah/withingsmcp) | `npm view` + registry sync |

## Infrastructure

| Project | npm package | npm version | Verification |
|---|---|---:|---|
| MCP Scorecard | [`mcp-scorecard`](https://www.npmjs.com/package/mcp-scorecard/v/0.5.5) | `0.5.5` | `npm view` + registry sync |
...
5. Update this index (or re-run the OSS-100 reconcile) so tables match npm.
6. Run `node scripts/validate-release-index.mjs` when available.
