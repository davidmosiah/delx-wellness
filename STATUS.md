...
_Auto-generated from `registry.json` on 2026-07-12 by `scripts/sync-registry.mjs`. Do not hand-edit — re-run the script._
...
| [Google Health](https://github.com/davidmosiah/google-health-mcp) | `google-health-mcp-unofficial` | `0.5.2` | agent_ready | identity, profile, settings, steps… |
...
| [Polar](https://github.com/davidmosiah/polarmcp) | `polar-mcp-unofficial` | `0.3.6` | agent_ready | account, devices, activity, calendar… |
...
| [WHOOP](https://github.com/davidmosiah/whoop-mcp) | `whoop-mcp-unofficial` | `0.5.3` | context_ready | profile, body, recovery, cycles… |
...
- **Meta-connectors**: 1
- **Profile packs**: 2
- **Last registry update**: 2026-07-12
