...
| [WHOOP](https://github.com/davidmosiah/whoop-mcp) | `whoop-mcp-unofficial` | `0.6.0` | context_ready | profile, body, recovery, cycles… |
| [Withings](https://github.com/davidmosiah/withingsmcp) | `withings-mcp-unofficial` | `0.5.0` | agent_ready | body_measures, daily_activity, workouts, sleep… |
