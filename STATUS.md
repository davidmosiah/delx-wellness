...
_Auto-generated from `registry.json` on 2026-06-16 by `scripts/sync-registry.mjs`. Do not hand-edit — re-run the script._

## Agent profiles

| Profile | npm version | Status |
|---|---|---|
| [Delx Wellness for Hermes](https://github.com/davidmosiah/delx-wellness-hermes) | `0.2.9` | active |
...
| [Garmin Connect](https://github.com/davidmosiah/garminmcp) | `garmin-mcp-unofficial` | `0.5.1` | context_ready | profile, devices, daily_movement, sleep… |
...
| [Strava](https://github.com/davidmosiah/strava-mcp) | `strava-mcp-unofficial` | `0.4.6` | context_ready | athlete, activities, activity_details, activity_streams… |
| [Wellness Air](https://github.com/davidmosiah/wellness-air) | `wellness-air` | `0.5.6` | agent_ready | PM2.5, PM10, CO2, VOC… |
...
| [WHOOP](https://github.com/davidmosiah/whoop-mcp) | `whoop-mcp-unofficial` | `0.5.0` | context_ready | profile, body, recovery, cycles… |
...
- **Profile packs**: 2
- **Last registry update**: 2026-06-16
