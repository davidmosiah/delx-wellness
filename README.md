...
- **[`google-health-mcp`](https://github.com/davidmosiah/google-health-mcp)** &mdash; Google Health API v4, Fitbit migration, rollups and reconciled streams. Strongest public discovery signal in the portfolio (**36★** · `google-health-mcp-unofficial@0.7.3`).
...
Have a Polar device?       → start with polar-mcp         (Nightly Recharge, training load, PPI/HRV)
Run/ride/swim a lot?       → add strava-mcp              (activities, streams, routes)
Just bought a Fitbit?      → add fitbit-mcp              (activity, sleep, heart, HRV)
...
**agent-safe-series/v1:** [docs/agent-safe-series.md](docs/agent-safe-series.md) · [proof hub](docs/proof/README.md) · [OSS policies](docs/oss-strategy-policies.md)
